    ...
    return (
        <div className="my-20 max-w-6xl mx-auto">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-8 px-16 lg:px-0 mt-10">
                {/* Coffee Card */}
                {
                    coffees.map(coffee => <Roll delay={1000} key={coffee.id}><div data-aos="fade-up" className="border relative border-brown-700 rounded-lg p-6 shadow-lg text-center h-[480px] max-w-sm hover:bg-[#623620] hover:text-white transition-colors duration-500">
                        ...
                        {/* Add to Cart Button */}
                        <div className="absolute lg:-mt-16 left-22 lg:left-32">
